...
def register_args(parser: framework.helpers.ArgumentParser):
    ...
    # Training
    parser.add_argument('-max_train_steps', default=1e6)
    parser.add_argument('-log_every_n_episodes', default=100)
    parser.add_argument('-opt_all.lr', default=3e-4)
    parser.add_argument('-save_freq', default=2e5)
    ...
    parser.add_argument('-eval_n_steps', default=-1) # set to -1 for not eval
    ...
    parser.add_argument('-ppo.batch_size', default=512)
    parser.add_argument('-ppo.n_epochs', default=3)
    ...
    parser.add_argument('-ppo.ent_coef', default=0.01)
